...
# If you are using a .env file to store your API key, you also need these:
# from dotenv import load_dotenv
# load_dotenv() # Call this once at the module level or in your app's main startup
...
class GeminiVisionAnalyzer:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        # The new google.genai library does not have genai.configure()
        # Instead, pass the API key directly to the GenerativeModel constructor.
        # So, remove: genai.configure(api_key=self.api_key)
        # -------------------------------
    ...
    def generate_hashtags(self, image, category: str, sentiment: str, count: int = 10):
        """
        Generate AI-based hashtags that match the image content.
        """
        try:
            prompt = f"""
    Look at this image and generate {count} Instagram hashtags.
    ...
    """
            ...
            print(f"Gemini hashtag error: {str(e)}")
            return []
